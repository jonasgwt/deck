...
def orderfaitems():
    ...
    for i in all_inventory:
        ...
        if (cart.objects.all().count()+ loancart.objects.all().count()) > 0:
...
def orderkits():
    ...
    for k in all_kits:
        ...
        if k.avg_transact_time:
            ...
            result.append(0)
        if kit_transactions.objects.all().count() > 0:
...
def sendmessageforlowqty(itemexpiry):
    ...
    if target.total_quantityopen <= target.min_quantityopen and target.total_quantityunopened <= target.min_quantityunopened:
        ...
        if target.image:
                telegram_bot_sendpmphoto(message, "Jonas", "https://deck.nhhs-sjb.org/uploaded/inventoryitemimages/"+target.image)
        else:
...
def report():
    ...
    for expired in itemexpire:
        ...
        telegram_bot_sendpmphoto(message, "Jonas", "https://deck.nhhs-sjb.org/uploaded/inventoryitemimages/"+expired.image)
    ...
    for expiring in itemwarn:
        ...
        if expiring.image == None:
            ...
            telegram_bot_sendpmphoto(message, "Jonas", "https://deck.nhhs-sjb.org/uploaded/inventoryitemimages/"+expiring.image)
    ...
    for expired in kitexpire:
        ...
        telegram_bot_sendpmphoto(message, "Jonas", "https://deck.nhhs-sjb.org/static/inventoryresource/"+expired.image)
    ...
    for expiring in kitwarn:
        ...
        if expiring.image == None:
            ...
            telegram_bot_sendpmphoto(message, "Jonas", "https://deck.nhhs-sjb.org/static/inventoryresource/"+expiring.image)
    ...
    for item in itemqtyopened:
        ...
        if item.image:
            telegram_bot_sendpmphoto(message, "Jonas", "https://deck.nhhs-sjb.org/uploaded/inventoryitemimages/"+item.image)
        else:
            telegram_bot_sendpmphoto(message, "Jonas", False)
